...
$$
P'=\left[\left[s\right]_xF\mid \mathbf{e}'\right]
$$
...
However, the camera center obtained above is at infinity. To see this, we just need to prove that the left $$3\times 3$$ matrix of $$P'$$ is singular, i.e., $$\left[s\right]_xF$$ has rank 2. (TBD).
